...
export const URLS = {
  ...
  otdr: {
    ...
    opticalroute:{
      ...
      opticalrouteRoute:"/otdr/optical-route/{optical_route_id}/routes",
      opticalrouteUpdateRoute:"/otdr/optical-route/{optical_route_id}/routes",
      opticalrouteDeleteRoute:"/otdr/optical-route/{optical_route_id}/routes",
      opticalrouteCreateRoute:"/otdr/optical-route/{optical_route_id}/routes",
