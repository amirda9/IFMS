...
import {alldeleteopticalroutetype,networkopticaltype} from '~/types/opticalrouteType'
import {
                      ...
                      ?.opticalrouts.map((data, index: number) => (
                        <div
                          ...
                          <SidebarItem
                            ...
                            onclick={() => {
                              setSelectedId(data.id), onclickoptical(data.id);
                            }}
                            onclickcheckbox={e =>
...
export default Opticalroutetree;
