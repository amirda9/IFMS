...
export const RequestList: Record<RequestKeys, T.ActionRequestType> = {
  ...
  opticalrouteDetail: {
    url: api.BASE_URL + api.URLS.otdr.opticalroute.opticalrouteDetail,
    method: 'get',
    auth: true,
  },
  opticalrouteRoute: {
    url: api.BASE_URL + api.URLS.otdr.opticalroute.opticalrouteRoute,
    method: 'get',
    auth: true,
  },
...
export type RequestListTypes = {
  ...
  SettingsUpdatesetmaintenance_test_setting:{data:{maintenance_test_setting: {
    test_mode:string,
    run_mode: string,
    distance_mode:string,
    range: number,
...
export type ResponseListType = {
  ...
  SettingsUpdatesetmaintenance_test_setting: T.settinggettype;
