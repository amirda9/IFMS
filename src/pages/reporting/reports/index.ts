export {default as reportsRoutesLayout} from './reportsRoutesLayout';

export {default as reports} from './reports';
export {default as reportsDetailpage} from './reportsDetailpage';
export {default as ReportDetailtable} from './reportDetailtable';
...
export {default as Createreportsparameters} from './createreportsparameters';
