...
const response=await $Put(`otdr/alarm/${params.alarmId}`,{
  alarm_definition: {
    low_severity: {
      conditions:alarmtypedetail.alarm_definition!.low_severity!.conditions!.map(data=>({
    ...
    medium_severity: {
      conditions:alarmtypedetail.alarm_definition!.medium_severity!.conditions!.map(data=>({
        parameter: data.parameter,
        operator:data.operator,
        coef:data.coef,
        value:data.value,
    ...
    high_severity: {
      conditions:alarmtypedetail.alarm_definition!.high_severity!.conditions!.map(data=>({
        parameter: data.parameter,
        operator:data.operator,
        coef:data.coef,
        value:data.value,
