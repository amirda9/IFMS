...
function CurrentReference() {
    ...
    const Getmeasermentsalarms = async () => {
      try {
        const response = await $Get(
          `otdr/optical-route/${opticalRouteId}/test-setups/${test_setup_id}`,
        );
  ...
  const Verticalbotton = ({name, ...props}: Verticalbotton) => {
    return (
      <button
        {...props}
        className={`${
        ...
        } mt-[3px] box-border h-[40px] w-[108px] text-center text-[18px] text-[18px] font-light leading-[21.87px]`}>
        {name}
      </button>
    );
  };
        ...
        <div className="flex h-full w-[108px] flex-col">
          <div className="flex  w-full flex-row">
            <div className="flex w-auto flex-col">
              ...
              <div className="mt-[240px] flex w-full flex-col">
                <span className="mb-2 mr-[45px] text-[24px] font-normal text-[#000000]">
